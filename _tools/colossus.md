...
- Download (Windows x64): [Colossus (v2.36)](https://tools.dtzxporter.com/colossus/Colossus-v2.3.6.zip).
...
## 📌 Versioning:
- 2.36 - Update program library for bug fixes and improvements.
- 2.35 - Update program library for ui improvements.
- 2.34 - Update program library for bug fixes and improvements.
...
- 2.27 - Update program library for bug fixes and improvements.
- 2.26 - Update program library to fix a TGA export bug.
- 2.25 - Update program library for improvements.
- 2.24 - Support for audio preview for WNO/WOB. Update program library for bug fixes and improvements.
- 2.23 - Support dct image files from WNO/WOB.
