...
- Download (Windows x64): [Henri (v1.33)](https://tools.dtzxporter.com/henri/Henri-v1.3.3.zip).
...
## 📌 Versioning:
- 1.33 - Update program library for bug fixes and improvements.
- 1.32 - Update program library for ui improvements.
- 1.31 - Update program library for bug fixes and improvements.
- 1.30 - Update program library for bug fixes and improvements.
- 1.29 - Update program library for bug fixes.
- 1.28 - Update program library to fix a preview bug.
- 1.27 - Update program library for general improvements.
- 1.26 - Update program library for bug fixes and improvements.
