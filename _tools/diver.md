...
- Download (Windows x64): [Diver (v1.67)](https://tools.dtzxporter.com/diver/Diver-v1.6.7.zip).
...
## 📌 Versioning:
- 1.67 - Update program library for bug fixes and improvements.
- 1.66 - Update program library for ui improvements.
- 1.65 - Fixed broken weights in some models after game patch.
- 1.64 - Update program library for bug fixes and improvements.
- 1.63 - Update program library for bug fixes and improvements.
- 1.62 - Update program library for bug fixes.
- 1.61 - Support for the latest game version.
