...
- Download (Windows x64): [Serrat (v1.25)](https://tools.dtzxporter.com/serrat/Serrat-v1.2.5.zip).
...
## 📌 Versioning:
- 1.25 - Update program library for bug fixes and improvements.
- 1.24 - Update program library for ui improvements.
- 1.23 - Update program library for bug fixes and improvements.
- 1.22 - Fix aliased animations only showing the first one in the list.
- 1.21 - Support non-default scaled animations.
- 1.20 - Support for latest game patch and dlc. Update program library for bug fixes and improvements.
- 1.19 - Update program library for bug fixes.
- 1.18 - Update program library to fix a preview bug.
- 1.17 - Update program library for general improvements.
- 1.16 - Update program library for bug fixes and improvements.
- 1.15 - Support for backwards compatible patch loading.
- 1.14 - Update program library to fix a TGA export bug.
- 1.13 - Update program library for bug fixes.
